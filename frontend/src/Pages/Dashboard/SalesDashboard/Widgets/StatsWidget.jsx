...
const StatsWidget = () => {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        // Fetch members
        const resMembers = await fetch("https://crm-r5rr.onrender.com/api/members/getMembers/Sales");
        ...
        // Fetch invoices
        const resInvoices = await fetch("https://crm-r5rr.onrender.com/api/invoice");
