...
const AccountSettings = () => {
  ...
  const handleUpdateProfile = async () => {
    try {
      const response = await axios.put(
        `https://crm-r5rr.onrender.com/api/members/update-profile/${team}/${userId}/${userRole}`,
        {
          name: userData.name,
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      const response = await axios.put(
        `https://crm-r5rr.onrender.com/api/members/update-password/${team}/${userId}/${userRole}`,
        {
