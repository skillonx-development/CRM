...
const SalesTeamWidget = () => {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        const response = await fetch("https://crm-5qj0.onrender.com/api/members/getMembers/Sales");
  ...
  const handleToggleApprove = async (id) => {
    try {
      ...
      const response = await fetch(`https://crm-5qj0.onrender.com/api/members/updateApproval/Sales/${id}`, {
        method: "PATCH",
