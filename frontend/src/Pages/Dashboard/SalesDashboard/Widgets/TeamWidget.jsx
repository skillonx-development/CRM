...
const SalesTeamWidget = () => {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        const response = await fetch("https://crm-r11b.onrender.com/api/members/getMembers/Sales");
  ...
  const handleToggleApprove = async (id) => {
    try {
      ...
      const response = await fetch(`https://crm-r11b.onrender.com/api/members/updateApproval/Sales/${id}`, {
        method: "PATCH",
