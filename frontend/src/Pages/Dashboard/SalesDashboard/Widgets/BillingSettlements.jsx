...
export default function BillingSettlements() {
  ...
  useEffect(() => {
    ...
    const fetchPayments = async () => {
      try {
        const res = await axios.get("/api/invoice"); // Add your actual endpoint here
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("/api/invoice/create", invoiceToAdd);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`/api/invoice/update/${editInvoice._id}`, updatedInvoice);
