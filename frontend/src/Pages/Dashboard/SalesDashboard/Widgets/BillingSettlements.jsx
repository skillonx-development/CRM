...
export default function BillingSettlements() {
  ...
  useEffect(() => {
    ...
    const fetchPayments = async () => {
      try {
        const res = await axios.get("https://crm-5qj0.onrender.com/api/invoice"); // Add your actual endpoint here
  ...
  const handleSendReminder = async (id, invoice) => {
    ...
    try {
      ...
      const response = await fetch("https://crm-5qj0.onrender.com/api/invoice/sendReminder", {
        method: "POST",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://crm-5qj0.onrender.com/api/invoice/create", invoiceToAdd);
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`https://crm-5qj0.onrender.com/api/invoice/update/${editInvoice._id}`, editInvoice);
