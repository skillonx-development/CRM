...
export default function OrderManagement() {
  ...
  const fetchSentProposals = async () => {
    try {
      const res = await axios.get("https://crm-5qj0.onrender.com/api/tech-proposals/sent");
  ...
  const saveChanges = async () => {
    try {
      await axios.put(`https://crm-5qj0.onrender.com/api/tech-proposals/${editData.id}`, {
  ...
  const sendEmail = async (order) => {
    try {
      setIsSending(true);
      await axios.put(`https://crm-5qj0.onrender.com/api/tech-proposals/${order.id}`, {
        title: order.title,
        status: "Sent",
      ...
      await axios.post(`https://crm-5qj0.onrender.com/api/tech-proposals/send-email/${order.id}`);
