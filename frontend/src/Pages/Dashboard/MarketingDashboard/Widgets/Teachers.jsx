...
export default function TeacherManagement() {
  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        const res = await axios.get("https://crm-5qj0.onrender.com/api/teachers");
  ...
  const handleAssignToWorkshop = async (proposal) => {
    try {
      ...
      await axios.post(
        `https://crm-5qj0.onrender.com/api/teachers/assign/${selectedTeacher}`,
        {
          ...
          <div className="bg-background-card p-6 rounded-lg shadow-lg w-[400px]">
            ...
            <form
              ...
              onSubmit={async (e) => {
                ...
                try {
                  await axios.put(
                    `https://crm-5qj0.onrender.com/api/teachers/${viewTeacher._id}`,
                    viewTeacher
                  );
                  setTeachers((prev) =>
