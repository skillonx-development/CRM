...
const TeamWidget = () => {
  ...
  useEffect(() => {
    const fetchMembers = async () => {
      try {
        const response = await fetch("https://crm-383e.onrender.com/api/members/getMembers/Tech");
  ...
  const handleToggleApprove = async (id) => {
    try {
      ...
      const response = await fetch(`https://crm-383e.onrender.com/api/members/updateApproval/Tech/${id}`, {
        method: "PATCH",
