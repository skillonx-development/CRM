...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch invoice data
        const invoiceRes = await axios.get("https://crm-4xul.onrender.com/api/invoice");
        ...
        const proposalsRes = await axios.get("https://crm-4xul.onrender.com/api/tech-proposals");
