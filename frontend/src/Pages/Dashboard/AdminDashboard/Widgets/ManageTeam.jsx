...
const ManageTeam = () => {
  ...
  useEffect(() => {
    const fetchLeads = async () => {
      try {
        const leadsRes = await axios.get(`https://crm-4772.onrender.com/api/members/getLeads/${activeTeam}`);
  ...
  const handleToggle = async (leadId) => {
    ...
    try {
      await axios.put(`https://crm-4772.onrender.com/api/members/updateLeadApproval/${leadId}`, {
        approve: newApproval,
      });
